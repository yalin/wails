...
| -debug               | Retains debug information in the application and shows the debug console. Permet l'utilisation des outils de développement dans la fenêtre de l'application                                                        |                                                                                                                                                                                                                       |
